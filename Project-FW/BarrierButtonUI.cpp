...
CBarrierButtonUI::CBarrierButtonUI() : m_nNum(0),
									   m_bPuton(false),
									   m_pButton(NULL),
									   m_pInfo(NULL),
									   m_pNumberUI(NULL)
...
void CBarrierButtonUI::Init(int Type, int Num)
{
	...
	wsprintf(filepath, "Resource/Image/Game/UI/Game_ui_bar_%d.png", Type) ;
	...
	wsprintf(filepath, "Resource/Image/Game/UI/Game_bar_info_%d.png", Type) ;
	m_pInfo = new CSprite ;
